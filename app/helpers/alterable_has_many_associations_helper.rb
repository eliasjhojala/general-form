      ...
      general_table do
        tag.tbody(class: "fields") do
          tag.tr(class: "subjectRow") do
            ...
            concat one_item(f: f, item_array_name: item_array_name, item_class: item_class, item_fields: item_fields) unless associated_object.any?
          end
        end + capture do
        ...
        concat tag.template(one_item(f: f, item_array_name: item_array_name, item_class: item_class, item_fields: item_fields), id: "new-item-template") unless options[:hide_add_button]
      end
